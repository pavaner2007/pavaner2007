...
**Frameworks & Web**
<br/>
<img src="https://skillicons.dev/icons?i=react,nodejs,express,html,css,fastapi&theme=dark" />

<br/><br/>

**Databases, Cloud & Tools**
<br/>
<img src="https://skillicons.dev/icons?i=mongodb,postgres,aws,vercel,render,git,github,vscode&theme=dark" />
...
| Domain | Details |
|:---|:---|
| Full Stack Web Dev | React, Node.js, Express, MongoDB |
| AI/ML Integration | LLM-powered chatbots (Groq LLaMA 3.3), RAG over PDFs/YouTube/web |
| Backend & APIs | FastAPI, PostgreSQL, REST API design |
| Core CS Fundamentals | DSA, OOPs, DBMS |
| Automation / Agents | Modular agent-based systems (GitPython, repo analysis) |
...
| Stack | Scale | Impact |
|:---|:---|:---|
| React · Node.js · MongoDB · Groq LLaMA 3.3 | Upload, search, bookmark & download academic resources | Personalized, context-aware learning experience for students |

🔗 **Repo:** `EDIT_ME → your Study Mate GitHub URL`
🔗 **Live:** `EDIT_ME → your Study Mate live deployment URL`

</details>

<details>
<summary><b>🤖 AutoQA Agent — Repository Intelligence Platform</b></summary>
<br/>

AI-powered repository analysis platform that scans GitHub repositories, detects technology stacks, discovers API endpoints, and generates structured audit reports through a modular, agent-based architecture.

| Stack | Scale | Impact |
|:---|:---|:---|
| FastAPI · PostgreSQL · React · GitPython | Automated codebase intelligence across any repo | Structured, repeatable software project auditing |

🔗 **Repo:** `EDIT_ME → your AutoQA Agent GitHub URL`
...
> No formal industry work experience yet — currently focused on academic projects, hackathons, and self-driven builds while completing my B.E.
...
[![LeetCode](https://img.shields.io/badge/LeetCode-75%2B_Solved-0D1117?style=for-the-badge&logo=leetcode&logoColor=00FF41&labelColor=0D1117)](EDIT_ME_LEETCODE_PROFILE_URL)
...
[![SkillRack](https://img.shields.io/badge/Skill_Rack-620%2B_Solved-0D1117?style=for-the-badge&labelColor=0D1117&color=00FF41)](EDIT_ME_SKILLRACK_PROFILE_URL)

*LeetCode Global Rank: 2,311,804 · Skill Rack: 178 Bronze, 2 Certificates*
